...
impl<'de> Deserialize<'de> for SgxReport {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let data = HexBytes::deserialize(deserializer)?;
        Ok(Self::from_bytes(&data))
    }
}

impl std::fmt::Debug for SgxReport {
...
impl<'de> Deserialize<'de> for SgxQuote {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let data = HexBytes::deserialize(deserializer)?;
        Ok(Self::from_bytes(data.into()).unwrap())
    }
}
...
impl std::fmt::Debug for SgxTarget {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.to_bytes().fmt(f)
    }
}

impl From<sgx_target_info_t> for SgxTarget {
    fn from(raw: sgx_target_info_t) -> Self {
        Self { raw }
    }
}

impl From<SgxTarget> for sgx_target_info_t {
    fn from(raw: SgxTarget) -> Self {
        raw.raw
    }
}
...
impl<'de> Deserialize<'de> for SgxTarget {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
